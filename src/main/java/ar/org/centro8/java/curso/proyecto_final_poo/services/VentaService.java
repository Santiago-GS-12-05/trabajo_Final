...
public class VentaService {
    ...
    public Venta buscar(int id){ return ventaRepo.findById(id); }
    ...
    public int crearVenta(int idCliente, List<Map<String, Integer>> items) {
        ...
        for (Map<String, Integer> it : items) {
            ...
            if (idProducto == null || cantidad == null || cantidad <= 0) continue;
    ...
    public List<DetalleVenta> detalles(int idVenta){ return detalleRepo.findByVenta(idVenta); }
